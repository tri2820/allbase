...
class HMRClient {
    constructor(logger, connection, importUpdatedModule) {
        ...
        this.hotModulesMap = /* @__PURE__ */
        new Map();
        this.disposeMap = /* @__PURE__ */
        new Map();
        this.pruneMap = /* @__PURE__ */
        new Map();
        this.dataMap = /* @__PURE__ */
        new Map();
        this.customListenersMap = /* @__PURE__ */
        new Map();
        this.ctxToListenersMap = /* @__PURE__ */
        new Map();
        this.updateQueue = [];
...
}, "server.hmr.overlay"), " to ", h("code", {
    part: "config-option-value"
}, "false"), " in ", h("code", {
    part: "config-file-name"
}, hmrConfigName), ".")), h("style", {}, templateStyle));
...
const outdatedLinkTags = /* @__PURE__ */
new WeakSet();
...
const hmrClient = new HMRClient(console,{
    ...
    const importPromise = import(/* @vite-ignore */
